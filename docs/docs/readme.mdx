...
You can [play around with a demo in your browser](https://stackblitz.com/github/zhouzi/graphql-codegen-factories/blob/main/packages/demo?file=/src/schema.graphql).
